...
type Props = {
    onderdeel: Onderdeel & {
        relaties?: Array<{
            ...
            emails?: EmailRecord[];
            pivot?: { functie: string | null; van: string; tot: string | null };
...
export default function OnderdeelShow({
    onderdeel,
    instrumentsByRelatie,
}: Props) {
            ...
            <div className="space-y-6 p-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Badge
                            variant={onderdeel.actief ? 'default' : 'outline'}
                        >
                            {onderdeel.actief ? t('Active') : t('Inactive')}
                        </Badge>
                ...
                <Dialog open={editOpen} onOpenChange={setEditOpen}>
                    <DialogContent>
                        ...
                        <form onSubmit={handleEditSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="edit-afkorting">
                                    {t('Abbreviation')}
                                </Label>
                                <Input
                                    id="edit-afkorting"
                                    value={data.afkorting}
                                    onChange={(e) =>
                                        setData('afkorting', e.target.value)
                                    }
                                    maxLength={10}
                                />
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="edit-beschrijving">
                                    {t('Description')}
                                </Label>
                                <Input
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    {t(
                                        'When enabled, member assignments to this section will not be removed by the SAD sync.',
                                    )}
                                </p>
                            </div>
                        ...
                        {onderdeel.relaties && onderdeel.relaties.length > 0 ? (
                            <div className="space-y-2">
                                {onderdeel.relaties.map((relatie) => {
                                    const instruments =
                                        instrumentsByRelatie[relatie.id] ?? [];
                                    return (
                                        <div
                                            key={relatie.id}
