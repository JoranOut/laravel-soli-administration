...
export default function RelatieOverviewTab({ relatie }: Props) {
    ...
    const cannotDeactivate =
        relatie.actief && (hasActiveLidmaatschap || hasActiveOnderdelen);
                ...
                <CardContent>
                    <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <dd>{relatie.voornaam}</dd>
                        </div>
                        <div>
                            <dt className="text-sm text-muted-foreground">
                                {t('Prefix')}
                            </dt>
                            <dd>{relatie.tussenvoegsel ?? '—'}</dd>
                        </div>
                        <div>
                            <dt className="text-sm text-muted-foreground">
                                {t('Last name')}
                            </dt>
                            <dd>{relatie.achternaam}</dd>
                        </div>
                        <div>
                            <dt className="text-sm text-muted-foreground">
                                {t('Date of birth')}
                            </dt>
                            <dd>{formatDate(relatie.geboortedatum)}</dd>
                        </div>
                        <div>
                            <dt className="text-sm text-muted-foreground">
                                {t('Status')}
                            ...
                            <dd>
                                <Badge
                                    variant={
                                        relatie.actief ? 'default' : 'outline'
                                    }
                                >
                                    {relatie.actief
                                        ? t('Active')
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                value={data.voornaam}
                                onChange={(e) =>
                                    setData('voornaam', e.target.value)
                                }
                            />
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('tussenvoegsel', e.target.value)
                                }
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('achternaam', e.target.value)
                                }
                            />
                        ...
                        <div className="space-y-3 pt-6">
                            <div className="space-y-1">
                                ...
                                {cannotDeactivate && (
                                    <p className="text-xs text-muted-foreground">
                                        {t(
                                            'Cannot deactivate: this relation still has an active membership or is part of a group.',
                                        )}
                                    </p>
                                )}
                            </div>
                            <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <Label htmlFor="beheerd_in_admin">
                                        {t('Managed in admin')}
                                    </Label>
                                </div>
                                <p className="text-xs text-muted-foreground">
                                    {t(
                                        'When enabled, this relation will not be overwritten by the SAD import.',
                                    )}
                                </p>
                            </div>
                        </div>
