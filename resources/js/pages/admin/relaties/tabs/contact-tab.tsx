                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('huisnummer', e.target.value)
                                }
                                required
                            />
                        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {isLoginEmail && (
                        <Alert className="border-amber-500/50 bg-amber-50 text-amber-900 dark:bg-amber-950/50 dark:text-amber-200">
                            ...
                            <AlertDescription>
                                {t(
                                    'This email is used as the login email. Changing it will also update the login email for the linked user account.',
                                )}
                            </AlertDescription>
                        </Alert>
                    )}
...
function AddTelefoonDialog({ relatieId }: { relatieId: number }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>{t('Add phone')}</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            value={data.nummer}
                            onChange={(e) => setData('nummer', e.target.value)}
                            required
                        />
                    </div>
                    <Button type="submit" disabled={processing}>
...
function EditTelefoonDialog({
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>{t('Edit phone')}</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        <Label>{t('Number')}</Label>
...
function AddGiroGegevenDialog({ relatieId }: { relatieId: number }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>{t('Add bank details')}</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        <Label>IBAN</Label>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                value={data.tenaamstelling}
                                onChange={(e) =>
                                    setData('tenaamstelling', e.target.value)
                                }
                            />
                        </div>
                    </div>
...
function EditGiroGegevenDialog({
    relatieId,
    giro,
}: {
    relatieId: number;
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>{t('Edit bank details')}</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        <Label>IBAN</Label>
                    ...
                    <div className="flex items-center gap-2">
                        <Checkbox
                            checked={data.machtiging}
                            onCheckedChange={(v) =>
                                setData('machtiging', v === true)
                            }
                        />
    ...
    return (
        <div className="space-y-6">
                    ...
                    {relatie.emails && relatie.emails.length > 0 ? (
                        <div className="space-y-3">
                            {relatie.emails.map((email) => {
                                const isLoginEmail =
                                    relatie.user?.email === email.email;
                                return (
                                    <div
                                        key={email.id}
                                        className="flex items-center justify-between rounded-md border p-3"
            ...
            <Card>
                ...
                <CardContent>
                    {relatie.giro_gegevens &&
                    relatie.giro_gegevens.length > 0 ? (
                        <div className="space-y-3">
