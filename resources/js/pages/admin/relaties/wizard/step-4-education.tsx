...
export default function Step4Education({ data, setData, errors }: Props) {
    ...
    const updateOpleiding = (
        index: number,
        field: keyof OpleidingEntry,
        value: string,
    ) => {
