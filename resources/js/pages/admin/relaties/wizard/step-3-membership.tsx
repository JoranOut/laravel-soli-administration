...
export default function Step3Membership({
    ...
    const updateLidmaatschap = (
        index: number,
        field: keyof LidmaatschapEntry,
        value: string,
    ) => {
    ...
    const updateOnderdeel = (
        index: number,
        field: keyof OnderdeelEntry,
        value: OnderdeelEntry[keyof OnderdeelEntry],
    ) => {
                                    ...
                                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            <InputError
                                                message={
                                                    errors[
                                                        `lidmaatschappen.${index}.lid_sinds`
                                                    ]
                                                }
                                            />
                                        </div>
                                        ...
                                        <div className="col-span-full space-y-2">
                                            <Label>
                                                {t('Reason for departure')}
                                            </Label>
                                            <Textarea
                                                value={lid.reden_vertrek}
                                                onChange={(e) =>
                                                    updateLidmaatschap(
                                                        index,
                                                        'reden_vertrek',
                                    ...
                                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                        ...
                                        <div className="col-span-full space-y-2">
                                            ...
                                            <InputError
                                                message={
                                                    errors[
                                                        `onderdelen.${index}.instrument_soort_ids`
                                                    ]
                                                }
                                            />
                                        </div>
