                ...
                <CardContent>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                            <Label htmlFor="relatie_nummer" required>
                                {t('Relation number')}
                            </Label>
                            <Input
                                id="relatie_nummer"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="voornaam" required>
                                {t('First name')}
                            </Label>
                            <Input
                                id="voornaam"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="achternaam" required>
                                {t('Last name')}
                            </Label>
                            <Input
                                id="achternaam"
