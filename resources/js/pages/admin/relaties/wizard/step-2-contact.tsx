...
type Props = {
    ...
    setData: <K extends keyof RelatieCreateFormData>(
        key: K,
...
export default function Step2Contact({ data, setData, errors }: Props) {
    ...
    const updateTelefoon = (
        index: number,
        field: keyof TelefoonEntry,
        value: string,
    ) => {
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Button
                        ...
                        variant="outline"
                        onClick={() =>
                            setData('emails', [...data.emails, emptyEmail()])
                        }
                    >
                        <Plus className="mr-2 h-4 w-4" />
                        {t('Add email')}
                                    ...
                                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <InputError
                                                message={
                                                    errors[
                                                        `giro_gegevens.${index}.tenaamstelling`
                                                    ]
                                                }
                                            />
                                        </div>
